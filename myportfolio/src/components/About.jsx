            ...
            <Col lg={4} align='center'>
              <Card className="nbcard">
                <Card.Body>
                  ...
                  <a className="social-icons" href="https://github.com/salavisushant" target="_blank" rel="noreferrer noopener">
                    <Button variant={darkMode ? "outline-light" : "outline-dark"}>
                      <FontAwesomeIcon className="dark" size="lg" icon={faGithub} />
                    </Button>
                  </a>

                  <a className="social-icons" href="https://www.instagram.com/sushant_salavi_2402/" target="_blank" rel="noreferrer noopener">
                    <Button variant={darkMode ? "outline-light" : "outline-dark"}>
